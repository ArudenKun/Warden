...
public class CollectionChangeAction<T> : IHistoryAction
{
    ...
    public CollectionChangeAction(
        ...
        T? oldItem = default,
        int toIndex = -1,
        IEnumerable<T>? clearedItems = null,
    ...
    )
    {
        ...
        _index = index;
        _toIndex = toIndex;
        _clearedItems = clearedItems is not null ? [.. clearedItems] : null;
