...
/// <summary>
/// Disposable returned by <see cref="History.Subscribe"/> to unsubscribe observers.
/// </summary>
internal sealed class UndoRedoServiceUnsubscriber : IDisposable
{
    ...
    public UndoRedoServiceUnsubscriber(
        List<IObserver<UndoRedoState>> observers,
        IObserver<UndoRedoState> observer,
        object sync
    )
    {
