...
/// </summary>
public class HistoryRegistrationTracker
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HistoryRegistrationTracker"/> class.
    /// </summary>
    /// <param name="service">Service used to push undoable actions.</param>
    /// <param name="logger">Logger for error reporting.</param>
    public HistoryRegistrationTracker(History service, ILogger? logger = null)
    {
        _history = service ?? throw new ArgumentNullException(nameof(service));
    ...
    )
    {
        ...
        var propHandlers = PropertyChangeRegistrar.Register(obj, _history, _valueCache, _logger);
