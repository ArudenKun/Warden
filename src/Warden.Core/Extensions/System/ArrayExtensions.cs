...
public static class ArrayExtensions
{
    ...
    public static T[] RemoveRange<T>(this T[] array, int startIndex)
    {
        if (startIndex < 0 || startIndex >= array.Length)
        {
            throw new ArgumentOutOfRangeException(
                nameof(startIndex),
                "The specified index is out of the array bounds."
            );
        }
    ...
    public static T[] RemoveRange<T>(this T[] array, int startIndex, int length)
    {
        ...
        if (startIndex + length > array.Length)
        {
            throw new ArgumentOutOfRangeException(
                nameof(length),
                "The range at the specified index is out of the array bounds."
            );
        }
    ...
    {
        return global::System.Buffers.Text.Base64Url.EncodeToString(value);
    }
