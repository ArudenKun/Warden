...
public static class ObjectExtensions
{
    ...
    public static PropertyInfo GetPropertyInfo(this object obj, string propertyName)
    {
        ...
        var map = PropertyMapCache.GetOrAdd(
            type,
            static t =>
            {
                var props = PropertyCache.GetOrAdd(
                    t,
                    static inner => inner.GetProperties(BindingFlags.Public | BindingFlags.Instance)
                );
        ...
        throw new InvalidOperationException(
            $"Property '{propertyName}' does not exist on type '{type.Name}'"
        );
    }
    ...
    /// </summary>
    public static bool IsAnyUnsignedInteger(this object? value) =>
        value is byte or ushort or uint or ulong;
    ...
    public static string ToTrimmedString(this object? input) =>
        input?.ToString()?.Trim() ?? string.Empty;
    ...
    /// </code>
    /// </example>
    public static short ToShortOrDefault(this object? input, short defaultValue = 0) =>
        input.ToShortOrNull() ?? defaultValue;
    ...
    public static short? ToShortOrNull(this object? input)
    {
        ...
        return Text.StringExtensions.ToShortOrNull(input.ToStringOrNull());
    }
    ...
    public static long ToLongOrDefault(this object? input, long defaultValue = 0) =>
        input.ToLongOrNull() ?? defaultValue;
    ...
    public static long? ToLongOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToLongOrNull(input.ToStringOrNull());
    }
    ...
    {
        return Text.StringExtensions.ToDecimalOrDefault(
            input.ToStringOrNull(),
            defaultValue,
            digits
        );
    }
    ...
    )
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToDecimalOrNull(input.ToStringOrNull(), defaultValue, digits);
    }
    ...
    public static int ToIntOrDefault(this object? input, int defaultValue = 0) =>
        input.ToIntOrNull() ?? defaultValue;
    ...
    public static int? ToIntOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToIntOrNull(input.ToStringOrNull());
    }
    ...
    {
        return Text.StringExtensions.ToDoubleOrDefault(
            input.ToStringOrNull(),
            defaultValue,
            digits
        );
    ...
    )
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToDoubleOrNull(input.ToStringOrNull(), defaultValue, digits);
    }
    ...
    {
        return Text.StringExtensions.ToFloatOrDefault(input.ToStringOrNull(), defaultValue, digits);
    }
    ...
    public static float? ToFloatOrNull(
        this object? input,
    ...
    )
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToFloatOrNull(input.ToStringOrNull(), defaultValue, digits);
    }
    ...
    public static DateTime? ToDateTimeOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToDateTimeOrNull(input.ToStringOrNull());
    }
    ...
    public static bool ToBoolOrDefault(this object? input, bool defaultValue = false) =>
        input.ToBoolOrNull() ?? defaultValue;
    ...
    public static bool? ToBoolOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToBoolOrNull(input.ToStringOrNull());
    }
    ...
    public static Guid? ToGuidOrNull(this object? value)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToGuidOrNull(value.ToStringOrNull());
    }
    ...
    /// </code>
    /// </example>
    public static byte ToByteOrDefault(this object? input, byte defaultValue = 0) =>
        input.ToByteOrNull() ?? defaultValue;
    ...
    public static byte? ToByteOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToByteOrNull(input.ToStringOrNull());
    }
    ...
    /// </code>
    /// </example>
    public static sbyte ToSByteOrDefault(this object? input, sbyte defaultValue = 0) =>
        input.ToSByteOrNull() ?? defaultValue;
    ...
    public static sbyte? ToSByteOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToSByteOrNull(input.ToStringOrNull());
    }
    ...
    /// </code>
    /// </example>
    public static uint ToUIntOrDefault(this object? input, uint defaultValue = 0) =>
        input.ToUIntOrNull() ?? defaultValue;
    ...
    public static uint? ToUIntOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToUIntOrNull(input.ToStringOrNull());
    }
    ...
    /// </code>
    /// </example>
    public static ulong ToULongOrDefault(this object? input, ulong defaultValue = 0) =>
        input.ToULongOrNull() ?? defaultValue;
    ...
    public static ulong? ToULongOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToULongOrNull(input.ToStringOrNull());
    }
    ...
    /// </code>
    /// </example>
    public static ushort ToUShortOrDefault(this object? input, ushort defaultValue = 0) =>
        input.ToUShortOrNull() ?? defaultValue;
    ...
    public static ushort? ToUShortOrNull(this object? input)
    {
        ...
        // Fall back to string conversion for other types
        return Text.StringExtensions.ToUShortOrNull(input.ToStringOrNull());
    }
