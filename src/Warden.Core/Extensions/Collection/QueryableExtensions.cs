...
public static class QueryableExtensions
{
    ...
    /// </code>
    /// </example>
    public static IQueryable<T> CreateOrderBy<T>(
    ...
    )
    {
        ...
        PropertyInfo property =
            type.GetProperty(orderByPropertyName)
            ?? throw new ArgumentException(
                $"Cannot find Property:{nameof(orderByPropertyName)} in {nameof(T)}"
            );
    ...
    {
        return condition ? (TQueryable)query.CreateOrderBy(sorting) : query;
    }
    ...
    )
    {
        ...
        {
            throw new ArgumentException(
                "The length of params cannot be zero",
                nameof(orderByPropertyList)
            );
        }
