...
/// </summary>
public class UndoRedoService : IObservable<UndoRedoState>, IHasExtraProperties
{
    ...
    public UndoRedoService(ILogger? logger)
    {
        Logger = logger ?? NullLogger.Instance;
        _tracker = new RegistrationTracker(this, Logger);
