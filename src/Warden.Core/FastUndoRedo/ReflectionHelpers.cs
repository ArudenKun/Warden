...
{
    private static readonly ConcurrentDictionary<string, Delegate> _setterCache =
    ...
    > _objectSetterCache = new ConcurrentDictionary<string, Action<object, object>>();
    private static readonly ConcurrentDictionary<string, Func<object, object>> _objectGetterCache =
        new ConcurrentDictionary<string, Func<object, object>>();
    private static readonly ConcurrentDictionary<string, PropertyInfo> _propertyCache =
        new ConcurrentDictionary<string, PropertyInfo>();
    private static readonly ConcurrentDictionary<string, PropertyInfo[]> _propertiesCache =
        new ConcurrentDictionary<string, PropertyInfo[]>();
