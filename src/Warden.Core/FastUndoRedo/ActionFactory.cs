...
using Warden.Core.FastUndoRedo.Actions;
...
public static class ActionFactory
{
    private static readonly ConcurrentDictionary<
        string,
        Func<object, object, object, object, string, IUndoableAction>
    > _propCtorCache =
    ...
    public static IUndoableAction CreatePropertyChangeAction(
        object target,
        PropertyInfo prop,
    ...
    )
    {
        ...
        var ctor = _propCtorCache.GetOrAdd(
            key,
    ...
    /// <param name="logger">The logger for error reporting.</param>
    /// <returns>The created undoable action, or null if creation failed.</returns>
    public static IUndoableAction CreateCollectionChangeAction(
    ...
    )
    {
        ...
        var ctor = _collectionCtorCache.GetOrAdd(
            key,
    ...
    private static Func<object, object, object, object, string, IUndoableAction> BuildPropertyCtor(
        Type targetType,
        Type valueType
    )
    {
