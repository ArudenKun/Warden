...
public static partial class StringExtensions
{
    ...
    public static bool IsIpAddress(this string? input)
    {
        ...
        return global::System.Net.IPAddress.IsValid(input);
    }
    ...
    public static bool IsIpv4(this string? input)
    {
        ...
        if (
            !global::System.Net.IPAddress.TryParse(input, out var ip)
    ...
    public static bool IsIpv6(this string? input)
    {
        ...
        return global::System.Net.IPAddress.TryParse(input, out var ip)
            && ip.AddressFamily == global::System.Net.Sockets.AddressFamily.InterNetworkV6;
    }
#else
    ...
    private static readonly Regex s_multipleMailRegex = new(
        MultipleMailRegexPattern,
    ...
    /// </code>
    /// </example>
    public static bool IsCombinationOfEnglishNumber(
        this string input,
        int? minLength = null,
        int? maxLength = null
    )
    ...
    /// </code>
    /// </example>
    public static bool IsCombinationOfEnglishNumberSymbol(
        this string input,
        int? minLength = null,
        int? maxLength = null
    )
    ...
    private static Regex GetCombinationRegex(int? minLength, int? maxLength, bool withSymbol)
    {
        ...
        return s_combinationRegexCache.GetOrAdd(
            pattern,
