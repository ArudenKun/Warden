...
public static partial class StringExtensions
{
    ...
    /// </summary>
    public static bool IsAnySignedInteger(this string? value) =>
        value.IsInt16() || value.IsInt() || value.IsInt64();
    ...
    public static decimal ToDecimalForScientificNotation(this string input)
    {
        ...
        {
            dData = Convert.ToDecimal(
                decimal.Parse(input, NumberStyles.Float, CultureInfo.InvariantCulture)
            );
        }
        else
        {
